...
class VectorStore(ABC):
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        return cls.from_texts(texts, embedding, metadatas=metadatas, metadata_addition=metadata_addition , **kwargs)
...
class VectorStoreRetriever(BaseRetriever):
    ...
    def _get_relevant_documents(
        ...
        if self.search_type == "similarity":
            query_category_index = self.vectorstore.get_category_index()
            docs = self.vectorstore.similarity_search(query, query_category_index , **self.search_kwargs)
